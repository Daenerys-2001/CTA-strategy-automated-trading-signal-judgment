...
mock_mss = {
    "xgboostmodelmss": {
        ...
        "xgboostlearner.targets": [1.2, -0.3, 1.0],  # 增加目标值
        "xgboostlearner.labels": ["ticker1_20230101", "ticker2_20230101", "ticker3_20230101"],
        "xgboostlearner.lastTrainDate": "20221231",
    },
    "ticker2wavesmss": {},
    "ticker2emamss": {
        "ticker1": [[1.0]*5, [12.0]*5, [4.0]*5],  
        "ticker2": [[1.0]*5, [12.0]*5, [4.0]*5],  
        "ticker3": [[1.0]*5, [2.0]*5, [11.0]*5], 
    },
    "currentprediction": np.array([-1.5, 1.8, 2.5]),  # 增加预测值
    "onmarketdata": np.array([110, 110, 110], dtype=np.int64),  # 增加市场数据值
    "ticker2feature": {
